...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_es4a/](https://arquisoft.github.io/lomap_es4a/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_es4a/](https://arquisoft.github.io/lomap_es4a/) necesitamos ejecutar `npm run deploy`.
