...
The deployment url is: [https://arquisoft.github.io/lomap_es4a/](https://arquisoft.github.io/lomap_es4a/).
...
If we want to deploy it to GitHub pages, so it is accesible via [https://arquisoft.github.io/lomap_es4a/](https://arquisoft.github.io/lomap_es4a/) we need to execute `npm run deploy`.
