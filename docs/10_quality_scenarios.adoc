...
| Privacy | Giving the users the control of the information saved and shared, we guarantee that there wouldn't be personal leaks. This is a result of the use of pods adn a very cared system of terms adn privacy options. | Medium-high
