...
The LoMap system is a software solution that allows the citizens of a city to share places of interest woth other users. These places are part of a map, and the users can give feedback about them to other users.
